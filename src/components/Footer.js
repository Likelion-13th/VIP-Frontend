    ...
    return (
        <div className="footer-container">
            <div className="footer-section">
                ...
                <div className="footer-subtitle">멋쟁이사자처럼은 창업 동아리이므로 실제 상품을 판매하지 않으며 연출된 페이지입니다.</div>
            </div>
        <div className="footer-section">
            <div className="info-text-row">
                ...
                <div className="info-text-wrapper">
                    ...
                    <div className="info-text-2">VIP</div>
                </div>
                <div className="info-text-wrapper">
                ...
                <div className="info-text-wrapper">
                    ...
                    <div className="info-text-2">경기도 고양시 덕양구 항공대학로 76-9 3층</div>
                </div>
            </div>
            <div className="info-text-row">
                <div className="info-text-wrapper">
                ...
                <div className="info-text-wrapper">
                    ...
                    <div className="info-text-2">VIP(help.VIP@likelion.com)</div>
                </div>
                <div className="info-text-wrapper">
                    <div className="info-text-1">입금계좌좌</div>
                    <div className="info-text-2">농협 356-1234-5678 김뷮</div>
                </div>
            </div>
        </div>
    </div>
